...
def book_appointment(request):
    ...
    form.fields['lead'].queryset = Lead.objects.filter(assigned_to=request.user)
...
def appointment_edit(request, appointment_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('appointments_list')  # Redirect to the appointment list after successful edit
    else:
